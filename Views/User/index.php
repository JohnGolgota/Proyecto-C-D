...
<head>
    ...
    <title>Puto Carpe Diem | Inicio </title>
...
<body class="" onload="OnloadFunction();">
    ...
    <header class="align-items-center navbar navbar-expand-sm position-relative header-reveal cabeza cabeza-dark" id="cabeza">
        <nav class="container-xxl cabeza-nav">
            ...
            <div class="elemento-icon-cabeza">
                <a href="index.html" target=""><img src="./Imagenes/favicon-min.png" alt="Logo" width="35px" class="nav-brand"></a>
            </div>
            ...
            <div class="navbar-nav d-inline align-items-end text-end position-absolute end-0 botones">
                ...
                <div class="contenido-switch my-auto">
                    <label class="switch align-items-center">
                        <input type="checkbox" class="input-banner" onclick="modoOscuro();" id="boton-dark-mode">
                ...
                <!-- Oculto -->
                <button class="oculto boton" onclick="menuDesplegable();">...</button>
    ...
    <main class="hell-main">
        ...
        <aside class="sacar-derecha">
            ...
            <!-- Facebook -->
            <div class="">
                <a href="https://www.facebook.com/" target="_blank"><img src="./Imagenes/LogosRedes/facebook.png" alt="Facebook" width="40px"></a>
            </div>

            <!-- Imgtagram -->
            <div class="">
                <a href="https://www.instagram.com/" target="_blank"><img src="./Imagenes/LogosRedes/instagram.png" alt="instagram" width="40px"></a>
            </div>
        </aside>
        ...
        <section class="text-center my-2 herramientas fs-4">
            ...
            <article class="row align-items-center herramienta herramienta-uno" id="HerramientaUno">
                ...
                <!-- imagen. Agenda -->
                <div class="col">
                    <img class="herramienta-img" src="./Imagenes/herramientas/Agenda.png" alt="Agenda">
                </div>
            ...
            <article class="row align-items-center my-2 herramienta herramienta-dos" id="HerramientaDos">
                ...
                <div class="col order-2">
                    <img class="herramienta-img" src="./Imagenes/herramientas/pomodoro-min.png" alt="HerramientaDos">
                </div>

                <!-- descripcion. HerramientaDos -->
                <div class="col order-1">
                    <h3>Pomodoro</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet doloribus architecto quidem impedit odit natus!</p>
                </div>
            </article>
            ...
            <article class="row align-items-center herramienta herramienta-tres" id="HerramientaTres">
                ...
                <div class="col">
                    <img class="herramienta-img" src="./Imagenes/herramientas/pareto-min.png" alt="HerramientaTres">
                </div>

                <!-- descripcion. HerramientaTres -->
                <div class="col">
                    <h3>Ley de pareto</h3>
                    <p class="">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aut aliquam neque vel, dolorem et placeat.</p>
                </div>
            </article>
            ...
            <article class="row align-items-center my-2 herramienta herramienta-cuatro" id="HerramientaCuatro">
                ...
                <div class="col order-2">
                    <img class="herramienta-img" src="./Imagenes/herramientas/doyouself-min.png" alt="HerramientaCuatro">
                </div>
        ...
        <div class="modal-dialog ">
            ...
            <div class="modal-content align-items-center">
                ...
                <div class="modal-header">
                    <img src="./Imagenes/favicon.png" alt="Logo" width="60px">
                </div>

                <!-- Cuerpo. Formulario -->
                <div class="modal-body formularios formulario-inicio">
                    <form action="./bd/conexion-php/iniciosesion.php" class="" method="POST" novalidate>
                ...
                <div class="modal-footer">
                    <a href="./Index-user.html"><img src="./Imagenes/LogosRedes/facebook.png" alt="Facebook" width="50px"></a>
                    <a href="./pruebaResponsive.html"><img src="./Imagenes/LogosRedes/instagram.png" alt="Google" width="50px"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content align-items-center">
                ...
                <div class="modal-body formularios formulario-registro">
                    <form action="./bd/conexion-php/registrousu.php" method="POST" novalidate id="formulario-registro" >
                        ...
                        <div class="form-group">
                            ...
                            <a href="#" onclick="detallesTC();">Detalles.</a>
                        </div>
                ...
                <div class="modal-footer">
                    <a href="./Descartables/Web/i.html"><img src="./Imagenes/LogosRedes/facebook.png" alt="Facebook" width="50px"></a>
                    <a href=""><img src="./Imagenes/LogosRedes/instagram.png" alt="Google" width="50px"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="./Scripts/iconrevel.min.js"></script>
